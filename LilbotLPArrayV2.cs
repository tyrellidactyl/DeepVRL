...
public class LilbotLPArrayV2 : MonoBehaviour
{
    ...
    private Vector3 hitPointLeft; // 4 This is the position where the laser hits.
    private Vector3 hitPointRight; // 4 This is the position where the laser hits.
    ...
    //public static List<List<int>> TOFreadings = new List<List<int>>();
    //public List<float> TOFreadings = new List<float> {hitPointCenterDist, hitPointLeftDist, hitPointRightDist};
    //public ArrayList TOFreadings = new ArrayList { CenterDist, LeftDist, RightDist };
    //public ArrayList TOFreadings = ArrayList { CenterDist, LeftDist, RightDist };
    ...
    void Start()
    {
        ...
        tr.sizeDelta = new Vector2(100, 100);
        trLeft.sizeDelta = new Vector2(100, 100);
        trRight.sizeDelta = new Vector2(100, 100);
    }
